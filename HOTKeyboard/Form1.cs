...
namespace WindowsFormsApplication1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            buchstabenListe.Add('כ', new[] { "כּ", "כְ", "כֱ", "כֲ", "כֳ", "כִ", "כֵ", "כֶ", "כַ", "כָ", "כֹ", "כֻ", "כְּ", "כֱּ", "כֲּ", "כֳּ", "כִּ", "כֵּ", "כֶּ", "כַּ", "כָּ", "כֹּ", "כֻּ", "ך", "ךּ", "ךְ", "ךָ" });
        ...
        {
            if (button27.Text.Length > 0) buttonToTextBox(button27.Text);
        }
